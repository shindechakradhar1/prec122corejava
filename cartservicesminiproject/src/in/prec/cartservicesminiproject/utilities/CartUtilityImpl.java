...
//		int total=0;
		...
		System.out.println("Cart List | total payable: " + service.calculateTotalSum(cart));
	...
	@Override
	public int printMenu(Scanner scanner, int attempts) {
		int choice=-1;
		if (attempts > 0) {
			try {
				System.out.println("Cart Menu remaining Attempts: " + attempts);
